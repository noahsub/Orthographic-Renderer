...
public static class Resolution
{
    public static readonly List<string> AspectRatio4X3 =
        ["VGA", "SVGA", "XGA", "XGA+", "SXGA", "SXGA+", "UXGA", "QXGA", "QSXGA", "QUXGA", "HUXGA", "WHUXGA"];

    public static readonly List<string> AspectRatio16X9 =
        ["720p", "1080p", "900p", "1440p", "4K", "5K", "8K", "10K", "12K", "14K", "16K", "24K"];

    public static readonly List<string> AspectRatio21X9 =
        ["UWHD", "UWQHD", "UWQHD+", "UW4K", "UW5K", "UW8K", "UW10K", "UW12K", "UW14K", "UW16K", "UW32K", "UW64K"];

    public static readonly List<string> AspectRatio1X1 =
        ["640p", "800p", "1024p", "1280p", "1600p", "1920p", "2560p", "3200p", "3840p", "5120p", "6400p", "8192p"];

    public static readonly Dictionary<string, Tuple<int, int>> ResolutionDictionary = new Dictionary<string, Tuple<int, int>>
    {
