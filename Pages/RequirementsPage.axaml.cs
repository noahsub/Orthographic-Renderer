...
public partial class RequirementsPage : UserControl, IPage
{
    ...
    public void Initialize()
    {
        ...
        ToolTip.SetTip(
            _blenderFilePathLabel,
            "The path to the version of Blender bundled with Orthographic Renderer"
        );
        ToolTip.SetTip(
            _blenderFilePathSelector,
            "The path to a locally installed version of Blender"
        );
    }
